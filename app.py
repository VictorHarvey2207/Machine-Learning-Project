...
with gr.Blocks(
    ...
    gr.HTML(background,elem_classes='background-img')
    ...
    with gr.Column(visible=False) as main_page:
        ...
        with gr.Tab("Model Prediction"):
            with gr.Row():
                 ...
                 with gr.Column(scale=1):
                    # --------------------------------------------------------------------------
                    model_input=gr.Dropdown(choices=["Linear Regression","Support Vector Machine","Gaussian Process Regression","Ensemble Learning with Decision Trees", "Polynomial Regression"],
                                            label="Model",
        ...
        with gr.Tab("Predict Part"):
            with gr.Row():
                with gr.Column():
                    ...
                    # --------------------------------------------------------------------------
                    model_predict=gr.Dropdown(choices=["Linear Regression","Support Vector Machine","Gaussian Process Regression","Ensemble Learning", "Polynomial Regression"],label="Model")
