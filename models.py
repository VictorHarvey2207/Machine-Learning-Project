...
class model():
    def __init__(self):
        ...
        self.models = {
            ...
            'Polynomial Regression': PolyRegression(degree=2)
        }
    ...
    def take_future_data(self,days):
        ...
        assess_data.drop(columns=['date', 'cushing_crude_oil_price'], inplace=True)
        assess_data.rename(columns={'cushing_crude_oil_price_from_date': 'cushing_crude_oil_price'}, inplace=True)
